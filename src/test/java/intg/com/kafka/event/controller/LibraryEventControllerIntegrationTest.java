...
public class LibraryEventControllerIntegrationTest {
    ...
    void postLibraryEvent() throws InterruptedException {
        ...
        //Thread.sleep(3000);
        String expectedRecord = "{\"libraryEventId\":null,\"libraryEventType\":\"NEW\",\"book\":{\"bookId\":545,\"bookName\":\"WE ARE THE ONE\",\"bookAuthor\":\"NORTH\"}}";
    ...
    void putLibraryEvent() throws InterruptedException {
        ...
        Book book = Book.builder().bookId(545).bookName("WE ARE THE ONE").bookAuthor("NORTH").build();
        LibraryEvent libraryEvent = LibraryEvent.builder().libraryEventId(788).book(book).build();
        HttpHeaders headers = new HttpHeaders();
        headers.set("content-type", MediaType.APPLICATION_JSON.toString());
        ...
        ConsumerRecord<Integer, String> consumerRecord = KafkaTestUtils.getSingleRecord(consumer, "Library-events");
        //Thread.sleep(3000);
        String expectedRecord = "{\"libraryEventId\":788,\"libraryEventType\":\"UPDATE\",\"book\":{\"bookId\":545,\"bookName\":\"WE ARE THE ONE\",\"bookAuthor\":\"NORTH\"}}";
        String value = consumerRecord.value();
        assertEquals(expectedRecord, value);
